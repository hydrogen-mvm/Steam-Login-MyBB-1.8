	...
	$plugin_templates = array(
		...
		<span class="welcome">
			<a href="{$mybb->settings[\'bburl\']}/misc.php?action=steam_login">
				<img border="0" src="https://steamcommunity-a.akamaihd.net/public/images/signinthroughsteam/sits_small.png" alt="Login through Steam" style="height: 24px;margin-bottom: -5px;margin-top: -2px;">
			</a>
		</span>
	</div>
</div>
